...
-- Date        : Wed May 19 22:17:45 2021
-- Host        : DESKTOP-NP3OOP3 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top uart_bmpg_1 -prefix
--               uart_bmpg_1_ uart_bmpg_0_sim_netlist.vhdl
-- Design      : uart_bmpg_0
...
entity uart_bmpg_1_axi_uart_baudrate is
  port (
  ...
  attribute ORIG_REF_NAME of uart_bmpg_1_axi_uart_baudrate : entity is "baudrate";
end uart_bmpg_1_axi_uart_baudrate;

architecture STRUCTURE of uart_bmpg_1_axi_uart_baudrate is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity uart_bmpg_1_axi_uart_cdc_sync is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of uart_bmpg_1_axi_uart_cdc_sync : entity is "cdc_sync";
end uart_bmpg_1_axi_uart_cdc_sync;

architecture STRUCTURE of uart_bmpg_1_axi_uart_cdc_sync is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity uart_bmpg_1_axi_uart_cntr_incr_decr_addn_f is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of uart_bmpg_1_axi_uart_cntr_incr_decr_addn_f : entity is "cntr_incr_decr_addn_f";
end uart_bmpg_1_axi_uart_cntr_incr_decr_addn_f;

architecture STRUCTURE of uart_bmpg_1_axi_uart_cntr_incr_decr_addn_f is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity uart_bmpg_1_axi_uart_cntr_incr_decr_addn_f_2 is
  port (
    Bus_RNW_reg : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of uart_bmpg_1_axi_uart_cntr_incr_decr_addn_f_2 : entity is "cntr_incr_decr_addn_f";
end uart_bmpg_1_axi_uart_cntr_incr_decr_addn_f_2;

architecture STRUCTURE of uart_bmpg_1_axi_uart_cntr_incr_decr_addn_f_2 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity uart_bmpg_1_axi_uart_dynshreg_f is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of uart_bmpg_1_axi_uart_dynshreg_f : entity is "dynshreg_f";
end uart_bmpg_1_axi_uart_dynshreg_f;

architecture STRUCTURE of uart_bmpg_1_axi_uart_dynshreg_f is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity uart_bmpg_1_axi_uart_dynshreg_f_3 is
  port (
    FIFO_Full_reg : in STD_LOGIC;
    fifo_Write : in STD_LOGIC;
    s_axi_aclk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of uart_bmpg_1_axi_uart_dynshreg_f_3 : entity is "dynshreg_f";
end uart_bmpg_1_axi_uart_dynshreg_f_3;

architecture STRUCTURE of uart_bmpg_1_axi_uart_dynshreg_f_3 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity uart_bmpg_1_axi_uart_dynshreg_i_f is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of uart_bmpg_1_axi_uart_dynshreg_i_f : entity is "dynshreg_i_f";
end uart_bmpg_1_axi_uart_dynshreg_i_f;

architecture STRUCTURE of uart_bmpg_1_axi_uart_dynshreg_i_f is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \uart_bmpg_1_axi_uart_dynshreg_i_f__parameterized0\ is
  port (
    en_16x_Baud : in STD_LOGIC;
    s_axi_aclk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \uart_bmpg_1_axi_uart_dynshreg_i_f__parameterized0\ : entity is "dynshreg_i_f";
end \uart_bmpg_1_axi_uart_dynshreg_i_f__parameterized0\;

architecture STRUCTURE of \uart_bmpg_1_axi_uart_dynshreg_i_f__parameterized0\ is
  signal \INFERRED_GEN.data_reg[14][0]_srl15_n_0\ : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity uart_bmpg_1_axi_uart_pselect_f is
  port (
    bus2ip_addr_i_reg : in STD_LOGIC_VECTOR ( 3 downto 2 );
    ce_expnd_i_3 : out STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of uart_bmpg_1_axi_uart_pselect_f : entity is "pselect_f";
end uart_bmpg_1_axi_uart_pselect_f;

architecture STRUCTURE of uart_bmpg_1_axi_uart_pselect_f is
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \uart_bmpg_1_axi_uart_pselect_f__parameterized1\ is
  port (
    bus2ip_addr_i_reg : in STD_LOGIC_VECTOR ( 3 downto 2 );
    ce_expnd_i_1 : out STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \uart_bmpg_1_axi_uart_pselect_f__parameterized1\ : entity is "pselect_f";
end \uart_bmpg_1_axi_uart_pselect_f__parameterized1\;

architecture STRUCTURE of \uart_bmpg_1_axi_uart_pselect_f__parameterized1\ is
begin
CS: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity uart_bmpg_1_axi_uart_address_decoder is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of uart_bmpg_1_axi_uart_address_decoder : entity is "address_decoder";
end uart_bmpg_1_axi_uart_address_decoder;

architecture STRUCTURE of uart_bmpg_1_axi_uart_address_decoder is
...
\MEM_DECODE_GEN[0].PER_CE_GEN[0].MULTIPLE_CES_THIS_CS_GEN.CE_I\: entity work.uart_bmpg_1_axi_uart_pselect_f
     port map (
      bus2ip_addr_i_reg(3 downto 2) => bus2ip_addr_i_reg(3 downto 2),
      ce_expnd_i_3 => ce_expnd_i_3
    );
\MEM_DECODE_GEN[0].PER_CE_GEN[2].MULTIPLE_CES_THIS_CS_GEN.CE_I\: entity work.\uart_bmpg_1_axi_uart_pselect_f__parameterized1\
     port map (
      bus2ip_addr_i_reg(3 downto 2) => bus2ip_addr_i_reg(3 downto 2),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity uart_bmpg_1_axi_uart_srl_fifo_rbu_f is
  port (
    Bus_RNW_reg : in STD_LOGIC;
    \^gen_bkend_ce_registers[1].ce_out_i_reg\ : in STD_LOGIC;
    \GEN_BKEND_CE_REGISTERS[1].ce_out_i_reg\ : in STD_LOGIC_VECTOR ( 1 to 1 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of uart_bmpg_1_axi_uart_srl_fifo_rbu_f : entity is "srl_fifo_rbu_f";
end uart_bmpg_1_axi_uart_srl_fifo_rbu_f;

architecture STRUCTURE of uart_bmpg_1_axi_uart_srl_fifo_rbu_f is
...
CNTR_INCR_DECR_ADDN_F_I: entity work.uart_bmpg_1_axi_uart_cntr_incr_decr_addn_f
     port map (
...
DYNSHREG_F_I: entity work.uart_bmpg_1_axi_uart_dynshreg_f
     port map (
      Q(3) => CNTR_INCR_DECR_ADDN_F_I_n_2,
      Q(2) => CNTR_INCR_DECR_ADDN_F_I_n_3,
      Q(1) => CNTR_INCR_DECR_ADDN_F_I_n_4,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity uart_bmpg_1_axi_uart_srl_fifo_rbu_f_1 is
  port (
    Bus_RNW_reg : in STD_LOGIC;
    Bus_RNW_reg_reg : in STD_LOGIC;
    \^gen_bkend_ce_registers[0].ce_out_i_reg\ : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of uart_bmpg_1_axi_uart_srl_fifo_rbu_f_1 : entity is "srl_fifo_rbu_f";
end uart_bmpg_1_axi_uart_srl_fifo_rbu_f_1;

architecture STRUCTURE of uart_bmpg_1_axi_uart_srl_fifo_rbu_f_1 is
  signal CNTR_INCR_DECR_ADDN_F_I_n_3 : STD_LOGIC;
  signal CNTR_INCR_DECR_ADDN_F_I_n_4 : STD_LOGIC;
  signal CNTR_INCR_DECR_ADDN_F_I_n_5 : STD_LOGIC;
...
CNTR_INCR_DECR_ADDN_F_I: entity work.uart_bmpg_1_axi_uart_cntr_incr_decr_addn_f_2
     port map (
      Bus_RNW_reg => Bus_RNW_reg,
...
DYNSHREG_F_I: entity work.uart_bmpg_1_axi_uart_dynshreg_f_3
     port map (
      FIFO_Full_reg => \^status_reg_reg\(2),
      Q(3) => CNTR_INCR_DECR_ADDN_F_I_n_3,
      Q(2) => CNTR_INCR_DECR_ADDN_F_I_n_4,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity uart_bmpg_1_axi_uart_slave_attachment is
  port (
    FIFO_Full_reg : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of uart_bmpg_1_axi_uart_slave_attachment : entity is "slave_attachment";
end uart_bmpg_1_axi_uart_slave_attachment;

architecture STRUCTURE of uart_bmpg_1_axi_uart_slave_attachment is
...
I_DECODER: entity work.uart_bmpg_1_axi_uart_address_decoder
     port map (
      D(1) => I_DECODER_n_5,
      D(0) => I_DECODER_n_6,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity uart_bmpg_1_axi_uart_srl_fifo_f is
  port (
    Bus_RNW_reg : in STD_LOGIC;
    \^gen_bkend_ce_registers[1].ce_out_i_reg\ : in STD_LOGIC;
    \GEN_BKEND_CE_REGISTERS[1].ce_out_i_reg\ : in STD_LOGIC_VECTOR ( 1 to 1 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of uart_bmpg_1_axi_uart_srl_fifo_f : entity is "srl_fifo_f";
end uart_bmpg_1_axi_uart_srl_fifo_f;

architecture STRUCTURE of uart_bmpg_1_axi_uart_srl_fifo_f is
  signal NLW_I_SRL_FIFO_RBU_F_mux_sel_reg_UNCONNECTED : STD_LOGIC_VECTOR ( 1 to 1 );
begin
I_SRL_FIFO_RBU_F: entity work.uart_bmpg_1_axi_uart_srl_fifo_rbu_f
     port map (
      Bus_RNW_reg => Bus_RNW_reg,
      \^gen_bkend_ce_registers[1].ce_out_i_reg\ => \^gen_bkend_ce_registers[1].ce_out_i_reg\,
      \GEN_BKEND_CE_REGISTERS[1].ce_out_i_reg\(1) => \GEN_BKEND_CE_REGISTERS[1].ce_out_i_reg\(1),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity uart_bmpg_1_axi_uart_srl_fifo_f_0 is
  port (
    Bus_RNW_reg : in STD_LOGIC;
    Bus_RNW_reg_reg : in STD_LOGIC;
    \^gen_bkend_ce_registers[0].ce_out_i_reg\ : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of uart_bmpg_1_axi_uart_srl_fifo_f_0 : entity is "srl_fifo_f";
end uart_bmpg_1_axi_uart_srl_fifo_f_0;

architecture STRUCTURE of uart_bmpg_1_axi_uart_srl_fifo_f_0 is
begin
I_SRL_FIFO_RBU_F: entity work.uart_bmpg_1_axi_uart_srl_fifo_rbu_f_1
     port map (
      Bus_RNW_reg => Bus_RNW_reg,
      Bus_RNW_reg_reg => Bus_RNW_reg_reg,
      \^gen_bkend_ce_registers[0].ce_out_i_reg\ => \^gen_bkend_ce_registers[0].ce_out_i_reg\,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity uart_bmpg_1_axi_uart_axi_lite_ipif is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of uart_bmpg_1_axi_uart_axi_lite_ipif : entity is "axi_lite_ipif";
end uart_bmpg_1_axi_uart_axi_lite_ipif;

architecture STRUCTURE of uart_bmpg_1_axi_uart_axi_lite_ipif is
begin
I_SLAVE_ATTACHMENT: entity work.uart_bmpg_1_axi_uart_slave_attachment
     port map (
      FIFO_Full_reg => FIFO_Full_reg,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity uart_bmpg_1_axi_uart_uartlite_rx is
  port (
    Bus_RNW_reg : in STD_LOGIC;
    Bus_RNW_reg_reg : in STD_LOGIC;
    \^gen_bkend_ce_registers[0].ce_out_i_reg\ : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of uart_bmpg_1_axi_uart_uartlite_rx : entity is "uartlite_rx";
end uart_bmpg_1_axi_uart_uartlite_rx;

architecture STRUCTURE of uart_bmpg_1_axi_uart_uartlite_rx is
...
begin
  SR(0) <= \^sr\(0);
DELAY_16_I: entity work.uart_bmpg_1_axi_uart_dynshreg_i_f
     port map (
...
INPUT_DOUBLE_REGS3: entity work.uart_bmpg_1_axi_uart_cdc_sync
     port map (
...
SRL_FIFO_I: entity work.uart_bmpg_1_axi_uart_srl_fifo_f_0
     port map (
      Bus_RNW_reg => Bus_RNW_reg,
      Bus_RNW_reg_reg => Bus_RNW_reg_reg,
      \^gen_bkend_ce_registers[0].ce_out_i_reg\ => \^gen_bkend_ce_registers[0].ce_out_i_reg\,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity uart_bmpg_1_axi_uart_uartlite_tx is
  port (
    Bus_RNW_reg : in STD_LOGIC;
    \^gen_bkend_ce_registers[1].ce_out_i_reg\ : in STD_LOGIC;
    \GEN_BKEND_CE_REGISTERS[1].ce_out_i_reg\ : in STD_LOGIC_VECTOR ( 1 to 1 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of uart_bmpg_1_axi_uart_uartlite_tx : entity is "uartlite_tx";
end uart_bmpg_1_axi_uart_uartlite_tx;

architecture STRUCTURE of uart_bmpg_1_axi_uart_uartlite_tx is
...
begin
MID_START_BIT_SRL16_I: entity work.\uart_bmpg_1_axi_uart_dynshreg_i_f__parameterized0\
     port map (
      en_16x_Baud => en_16x_Baud,
      s_axi_aclk => s_axi_aclk,
...
SRL_FIFO_I: entity work.uart_bmpg_1_axi_uart_srl_fifo_f
     port map (
      Bus_RNW_reg => Bus_RNW_reg,
      \^gen_bkend_ce_registers[1].ce_out_i_reg\ => \^gen_bkend_ce_registers[1].ce_out_i_reg\,
      \GEN_BKEND_CE_REGISTERS[1].ce_out_i_reg\(1) => \GEN_BKEND_CE_REGISTERS[1].ce_out_i_reg\(1),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity uart_bmpg_1_axi_uart_uartlite_core is
  port (
    Bus_RNW_reg : in STD_LOGIC;
    Bus_RNW_reg_reg : in STD_LOGIC;
    \^gen_bkend_ce_registers[0].ce_out_i_reg\ : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of uart_bmpg_1_axi_uart_uartlite_core : entity is "uartlite_core";
end uart_bmpg_1_axi_uart_uartlite_core;

architecture STRUCTURE of uart_bmpg_1_axi_uart_uartlite_core is
...
begin
  ...
  enable_interrupts <= \^enable_interrupts\;
  status_reg(1 downto 0) <= \^status_reg\(1 downto 0);
BAUD_RATE_I: entity work.uart_bmpg_1_axi_uart_baudrate
     port map (
      SR(0) => \^bus2ip_reset\,
      en_16x_Baud => en_16x_Baud,
      s_axi_aclk => s_axi_aclk
...
UARTLITE_RX_I: entity work.uart_bmpg_1_axi_uart_uartlite_rx
     port map (
      Bus_RNW_reg => Bus_RNW_reg,
      Bus_RNW_reg_reg => Bus_RNW_reg_reg,
      \^gen_bkend_ce_registers[0].ce_out_i_reg\ => \^gen_bkend_ce_registers[0].ce_out_i_reg\,
...
UARTLITE_TX_I: entity work.uart_bmpg_1_axi_uart_uartlite_tx
     port map (
      Bus_RNW_reg => Bus_RNW_reg,
      \^gen_bkend_ce_registers[1].ce_out_i_reg\ => \^gen_bkend_ce_registers[1].ce_out_i_reg\,
      \GEN_BKEND_CE_REGISTERS[1].ce_out_i_reg\(1) => \GEN_BKEND_CE_REGISTERS[1].ce_out_i_reg\(1),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity uart_bmpg_1_axi_uart_axi_uartlite is
  port (
    interrupt : out STD_LOGIC;
    rx : in STD_LOGIC;
    s_axi_aclk : in STD_LOGIC;
  ...
  attribute C_BAUDRATE of uart_bmpg_1_axi_uart_axi_uartlite : entity is 128000;
  attribute C_DATA_BITS : integer;
  attribute C_DATA_BITS of uart_bmpg_1_axi_uart_axi_uartlite : entity is 8;
  attribute C_FAMILY : string;
  attribute C_FAMILY of uart_bmpg_1_axi_uart_axi_uartlite : entity is "artix7";
  attribute C_ODD_PARITY : integer;
  attribute C_ODD_PARITY of uart_bmpg_1_axi_uart_axi_uartlite : entity is 0;
  attribute C_S_AXI_ACLK_FREQ_HZ : integer;
  attribute C_S_AXI_ACLK_FREQ_HZ of uart_bmpg_1_axi_uart_axi_uartlite : entity is 10000000;
  attribute C_S_AXI_ADDR_WIDTH : integer;
  attribute C_S_AXI_ADDR_WIDTH of uart_bmpg_1_axi_uart_axi_uartlite : entity is 4;
  attribute C_S_AXI_DATA_WIDTH : integer;
  attribute C_S_AXI_DATA_WIDTH of uart_bmpg_1_axi_uart_axi_uartlite : entity is 32;
  attribute C_USE_PARITY : integer;
  attribute C_USE_PARITY of uart_bmpg_1_axi_uart_axi_uartlite : entity is 0;
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of uart_bmpg_1_axi_uart_axi_uartlite : entity is "yes";
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of uart_bmpg_1_axi_uart_axi_uartlite : entity is "axi_uartlite";
end uart_bmpg_1_axi_uart_axi_uartlite;

architecture STRUCTURE of uart_bmpg_1_axi_uart_axi_uartlite is
...
AXI_LITE_IPIF_I: entity work.uart_bmpg_1_axi_uart_axi_lite_ipif
     port map (
...
UARTLITE_CORE_I: entity work.uart_bmpg_1_axi_uart_uartlite_core
     port map (
      Bus_RNW_reg => \I_SLAVE_ATTACHMENT/I_DECODER/Bus_RNW_reg\,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity uart_bmpg_1_axi_uart is
  port (
    interrupt : out STD_LOGIC;
    rx : in STD_LOGIC;
    s_axi_aclk : in STD_LOGIC;
  ...
  attribute CHECK_LICENSE_TYPE of uart_bmpg_1_axi_uart : entity is "axi_uart,axi_uartlite,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of uart_bmpg_1_axi_uart : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of uart_bmpg_1_axi_uart : entity is "axi_uartlite,Vivado 2017.4";
end uart_bmpg_1_axi_uart;

architecture STRUCTURE of uart_bmpg_1_axi_uart is
  attribute C_BAUDRATE : integer;
...
begin
U0: entity work.uart_bmpg_1_axi_uart_axi_uartlite
     port map (
      interrupt => interrupt,
      rx => rx,
      s_axi_aclk => s_axi_aclk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity uart_bmpg_1_uart_bmpg is
  port (
  ...
  attribute ADDR_WIDTH of uart_bmpg_1_uart_bmpg : entity is 15;
  attribute DATA_WIDTH : integer;
  attribute DATA_WIDTH of uart_bmpg_1_uart_bmpg : entity is 32;
  attribute JUDGE_RRDY : integer;
  attribute JUDGE_RRDY of uart_bmpg_1_uart_bmpg : entity is 2;
  attribute JUDGE_WRDY : integer;
  attribute JUDGE_WRDY of uart_bmpg_1_uart_bmpg : entity is 2;
  attribute MSG_LEN : integer;
  attribute MSG_LEN of uart_bmpg_1_uart_bmpg : entity is 38;
  attribute RDATA : integer;
  attribute RDATA of uart_bmpg_1_uart_bmpg : entity is 3;
  attribute RDATA_VALID : integer;
  attribute RDATA_VALID of uart_bmpg_1_uart_bmpg : entity is 1;
  attribute RDELAY : integer;
  attribute RDELAY of uart_bmpg_1_uart_bmpg : entity is 4;
  attribute RIDLE : integer;
  attribute RIDLE of uart_bmpg_1_uart_bmpg : entity is 0;
  attribute WAIT_NUM : integer;
  attribute WAIT_NUM of uart_bmpg_1_uart_bmpg : entity is 765;
  attribute WDATA : integer;
  attribute WDATA of uart_bmpg_1_uart_bmpg : entity is 3;
  attribute WDATA_VALID : integer;
  attribute WDATA_VALID of uart_bmpg_1_uart_bmpg : entity is 1;
  attribute WDELAY : integer;
  attribute WDELAY of uart_bmpg_1_uart_bmpg : entity is 4;
  attribute WIDLE : integer;
  attribute WIDLE of uart_bmpg_1_uart_bmpg : entity is 0;
end uart_bmpg_1_uart_bmpg;

architecture STRUCTURE of uart_bmpg_1_uart_bmpg is
...
axi_uart_inst: entity work.uart_bmpg_1_axi_uart
     port map (
...
architecture STRUCTURE of uart_bmpg_1_upg is
begin
upg_inst: entity work.uart_bmpg_1_uart_bmpg
     port map (
...
entity uart_bmpg_1 is
  ...
  attribute NotValidForBitStream of uart_bmpg_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of uart_bmpg_1 : entity is "uart_bmpg_0,upg,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of uart_bmpg_1 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of uart_bmpg_1 : entity is "upg,Vivado 2017.4";
end uart_bmpg_1;

architecture STRUCTURE of uart_bmpg_1 is
begin
inst: entity work.uart_bmpg_1_upg
     port map (
      upg_adr_o(14 downto 0) => upg_adr_o(14 downto 0),
      upg_clk_i => upg_clk_i,
      upg_clk_o => upg_clk_o,
